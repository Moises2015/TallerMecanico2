...
class FichasControllerTest < ActionController::TestCase
  ...
  test "should create ficha" do
    assert_difference('Ficha.count') do
      post :create, ficha: { cliente_id: @ficha.cliente_id, diagnostico: @ficha.diagnostico, falla: @ficha.falla, numeroficha: @ficha.numeroficha, total: @ficha.total, vehiculo_id: @ficha.vehiculo_id }
    end
  ...
  test "should update ficha" do
    patch :update, id: @ficha, ficha: { cliente_id: @ficha.cliente_id, diagnostico: @ficha.diagnostico, falla: @ficha.falla, numeroficha: @ficha.numeroficha, total: @ficha.total, vehiculo_id: @ficha.vehiculo_id }
    assert_redirected_to ficha_path(assigns(:ficha))
  end
